...
void plant_cactus::update(plant& p) {
    ...
    case plant_status::cactus_grow_tall:
        if (p.reanim.n_repeated > 0) {
            ...
            p.set_reanim("anim_idlehigh", reanim_type::repeat, 0);
    ...
    case plant_status::cactus_tall_idle:
        if (!find_target(p, p.row, false)) {
            ...
            p.set_reanim("anim_lower", reanim_type::once, 12);
        }
        break;
    ...
    case plant_status::cactus_get_short:
        if (p.reanim.n_repeated > 0) {
            ...
            p.set_reanim("anim_idle", reanim_type::repeat, 0);
        }
        break;
    ...
    default:
        if (find_target(p, p.row, false)) {
            ...
            p.set_reanim("anim_rise", reanim_type::once, 12);
        }
    }
}
